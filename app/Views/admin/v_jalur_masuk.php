                ...
                <tbody>
                    ...
                    foreach ($jalurmasuk as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value['kuota'] ?></td>
                            <td> <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_jalur_masuk'] ?>"><i class="fas fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_jalur_masuk'] ?>"><i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    <?php } ?>
  ...
  <div class="modal fade" id="delete<?= $value['id_jalur_masuk'] ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Apakah Anda Ingin Menghapus <b><?= $value['id_jalur_masuk'] ?></b> ?
        </div>
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
