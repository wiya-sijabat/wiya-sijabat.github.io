    ...
    <div class="card card-info">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" class="btn btn-flat btn-light btn-xs" data-toggle="modal" data-target="#add"><i class="fas fa-plus">Add</i>
                </button>
            </div>
        </div>
        <!-- /.card-header -->
                ...
                <tbody>
                    ...
                    foreach ($pekerjaan as $key => $value) { ?>
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_pekerjaan']?>"><i class="fas fa-edit"></i></button>&nbsp;
                            <button type="button" class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_pekerjaan']?>"><i class="fas fa-trash"></i></button></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input name="pekerjaan1" class="form-control" placeholder="Pekerjaan" required autofocus>
                  </div>
            </div>
