        ...
        <tbody>
          ...
          foreach ($jurusan as $key => $value) { ?>
            <tr>
              <td><?= $no++ ?></td>
              <td><?= $value['jurusan'] ?></td>
              <td> <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_jurusan'] ?>"><i class="fas fa-edit"></i>
                </button>
                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_jurusan'] ?>"><i class="fas fa-trash"></i>
                </button>
              </td>
            </tr>
          <?php } ?>
